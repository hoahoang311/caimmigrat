...
export const metadata: Metadata = {
  ...
  description: "Contact ICBM Law for expert Canadian immigration consultation. Visit our Toronto office, call +1 416-639-2655, or email info@icbmlaw.ca. Virtual consultations available.",
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              ...
              <Card className="border-primary/20 bg-primary/5">
                <CardHeader>
                  <CardTitle className="text-primary">{t('contact.page.urgent_assistance_title')}</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
                ...
                <CardContent>
                  <div className="flex space-x-4">
                    <a href="https://www.facebook.com/profile.php?id=61581800467455" target="_blank" rel="noopener noreferrer" className="p-3 bg-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 group" aria-label="Facebook">
                      <Facebook className="h-6 w-6 text-primary group-hover:text-primary/80" />
                    </a>
                    <a href="https://www.instagram.com/icbm.law.ca/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 group" aria-label="Instagram">
                      <Instagram className="h-6 w-6 text-[#D9BA4E] group-hover:text-[#c9a83e]" />
                    </a>
                    <a href="https://www.tiktok.com/@icbm.law.ca" target="_blank" rel="noopener noreferrer" className="p-3 bg-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 group" aria-label="TikTok">
