...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for ICBM Law - Learn how we collect, use, and protect your personal information.",
};
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ICBM Law ("we," "us," or "our") is committed to protecting your privacy and personal information. 
                This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you 
                visit our website or use our immigration consultation services.
              </p>
            </section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                    ...
                    <li>Date of birth, place of birth, and citizenship information</li>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    IP address, browser type, device information, and website usage patterns through cookies and 
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                ...
                <li>Maintaining accurate records for professional obligations</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                <li>With Immigration, Refugees and Citizenship Canada (IRCC) and other government agencies</li>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                secure file storage, encrypted communications, and regular security assessments.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                with legal and professional obligations. Immigration-related documents are typically retained 
                for a minimum of seven years after the completion of your case, as required by regulatory standards.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Our website uses cookies to enhance user experience and analyze website traffic. You can control 
                cookie settings through your browser preferences. Some features of our website may not function 
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                laws. We will notify you of significant changes by posting the updated policy on our website with 
